...
export const permissions = definePermissions<AuthData, Schema>(schema, () => {
  return {
    ...
    agent_conversations: organizationScoped<'agent_conversations'>(),
    agent_runs: organizationScoped<'agent_runs'>(),
    agent_messages: organizationScoped<'agent_messages'>(),
    agent_run_input_media_objects: unscopedOnly,
    agent_run_input_media: organizationScoped<'agent_run_input_media'>(),
    agent_terminals: organizationScoped<'agent_terminals'>(),
    agent_run_progress_reports: organizationScoped<'agent_run_progress_reports'>(),
    agent_run_artifacts: organizationScoped<'agent_run_artifacts'>(),
    github_branches: organizationScoped<'github_branches'>(),
    github_pull_requests: organizationScoped<'github_pull_requests'>(),
