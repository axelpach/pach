...
export const permissions = definePermissions<AuthData, Schema>(schema, () => {
  return {
    ...
    google_ads_accounts: organizationScoped<'google_ads_accounts'>(),
    ...
    search_console_dimension_summaries: organizationScoped<'search_console_dimension_summaries'>(),
    search_console_daily_snapshots: organizationScoped<'search_console_daily_snapshots'>(),
