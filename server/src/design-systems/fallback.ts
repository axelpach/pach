...
const ARDIA_METADATA = {
  ...
  requiredDesignContract: {
    ...
    nonNegotiables: [
      ...
      'Use Inter Tight 200 for large display titles, Geist Mono for small technical labels, and Instrument Serif italic only as one restrained accent line or phrase.',
      ...
      'Keep backgrounds near black, structure with whitespace and one-pixel hairlines, and use vermilion as a precise accent rather than a large filled brand block.',
  ...
  agentInstruction: [
    'MANDATORY ARDIA DESIGN CONTRACT: match the Ardia buyer landing and the Pach legacy Ardia one-pager / Universo aBanza onboarding decks for every Ardia template edit.',
    'Treat metadata.requiredDesignContract as a QA checklist before saving; this is a hard constraint, not optional inspiration.',
    'Do not drift into a generic executive deck, generic SaaS cards, blue/purple gradients, glowing panels, large serif primary titles, or fake square logos.',
    'Use Inter Tight 200 for large titles, Geist Mono for small labels, and Instrument Serif italic only as one restrained accent phrase or line.',
