...
function buildDesignTemplateMcpPrompt(run: AgentRunRecord) {
  ...
  return [
    ...
    organizationProject === 'ardia' ? 'Ardia-specific rule: match the buyer landing plus the Pach legacy ardia-one-pager and Universo aBanza onboarding decks. Use Inter Tight 200 titles, one restrained Instrument Serif italic accent, real Ardia mark, hairline product/data surfaces, and fixed-size slide components rather than one long scrolling document.' : null,
