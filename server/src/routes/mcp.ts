    ...
    agentInstructions: {
      ...
      instruction: [
        ...
        organization?.project === 'ardia'
          ? 'For Ardia, organizationDesignSystem.metadata.requiredDesignContract is mandatory. Treat the Ardia buyer landing, Pach legacy ardia-one-pager, and Universo aBanza onboarding decks as canonical references, not loose inspiration. Do not drift into generic executive decks, generic SaaS cards, blue/purple gradients, glowing panels, large serif primary titles, fake square logos, or one long scrolling document. Use Inter Tight 200 display titles, Geist Mono labels, one restrained Instrument Serif italic accent, real Ardia logo/assets, hairline dividers, quiet product/data surfaces, and real fixed-size slide components.'
          : '',
        assets.length > 0
