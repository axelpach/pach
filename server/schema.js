...
const mktAdPromotions = table('mkt_ad_promotions')
    ...
    providerResponse: json().optional().from('provider_response'),
    publishedAt: number().optional().from('published_at'),
    metadata: json(),
    createdAt: number().from('created_at'),
    updatedAt: number().from('updated_at'),
...
export const permissions = definePermissions(schema, () => {
    return {
        ...
        cal_calendar_connections: organizationScoped(),
        cal_external_calendars: organizationScoped(),
        cal_event_types: organizationScoped(),
        cal_availability_rules: organizationScoped(),
        cal_availability_overrides: organizationScoped(),
        cal_bookings: organizationScoped(),
        ...
        mkt_content_items: organizationScoped(),
        mkt_editorial_ideas: organizationScoped(),
        mkt_audience_members: organizationScoped(),
        mkt_audience_subscriptions: organizationScoped(),
        mkt_segments: organizationScoped(),
        mkt_segment_members: organizationScoped(),
        mkt_distribution_runs: organizationScoped(),
        mkt_publication_slots: organizationScoped(),
        ...
        google_ads_accounts: organizationScoped(),
