...
const processSteps = [
  { day: 'Día 1-3', label: 'Facturación', manual: true, who: 'Daniel' },
  { day: 'Día 4', label: 'Relación de facturas', manual: false, who: 'Laura' },
  { day: 'Día 11', label: 'Cobro y aplicación en sistema', manual: true, who: 'Laura' },
  { day: 'Día 12-14', label: 'Contacto con cliente', manual: true, who: 'Laura' },
  { day: 'Día 20', label: 'Recordatorio 1 — cordial', manual: true, who: 'Laura' },
  { day: 'Día 25', label: 'Recordatorio 2 — firme', manual: true, who: 'Laura' },
  { day: 'Día 30', label: 'Recordatorio 3 — urgente', manual: true, who: 'Laura' },
  { day: 'Día 32', label: 'Cobranza administrativa', manual: true, who: 'Laura' },
  { day: 'Día 32+', label: 'Cobranza externa', manual: false, who: '' },
]
