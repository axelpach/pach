  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="bg-bg-2 border border-edge/35 shadow-glow-sm w-full max-w-2xl max-h-[80vh] flex flex-col pointer-events-auto font-mono">
          <div className="px-6 py-4 border-b border-edge/15 flex items-center justify-between">
            <div className="text-base text-accent uppercase tracking-label glow">◊ nueva campaña</div>
          ...
          <div className="flex-1 overflow-auto p-6 space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-rim border border-edge/15 text-fg-1 text-sm placeholder:text-fg-4 outline-none focus:border-accent focus:shadow-glow-xs"
              />
            </div>
            ...
            <div>
              ...
              <div className="max-h-80 overflow-auto border border-edge/15">
                {templates.length === 0 && (
                ...
                {templates.map(t => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2.5 flex items-center gap-3 border-b border-edge/8 last:border-b-0 transition-colors ${
                        sel ? 'bg-accent-fill/6' : 'hover:bg-accent-fill/3'
                      }`}
                    >
          ...
          <div className="px-6 py-4 border-t border-edge/15 flex justify-end gap-2">
